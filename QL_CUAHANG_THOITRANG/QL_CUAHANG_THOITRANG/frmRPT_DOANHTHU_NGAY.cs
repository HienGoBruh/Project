...
{
    public partial class frmRPT_DOANHTHU_NGAY : Form
    {
        public frmRPT_DOANHTHU_NGAY()
        {
            InitializeComponent();
        }
        ...
        private void btnINBC_Click(object sender, EventArgs e)
        {
            ...
            this.DOANHTHU_THEONGAYTableAdapter.Fill(this.QL_CUAHANG_THOITRANGDataSet.DOANHTHU_THEONGAY, tuNgay, denNgay);
            this.reportViewer1.RefreshReport(); 
        }

        private void btnTAIBC_Click(object sender, EventArgs e)
        {
            if (this.QL_CUAHANG_THOITRANGDataSet.DOANHTHU_THEONGAY.Rows.Count > 0)
            {
                try
                {
                    ...
                    saveFileDialog.FileName = "BaoCao_DoanhThu_Theongay.pdf";
