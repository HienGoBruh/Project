...
{
    public partial class frmRPT_LOINHUAN_SP : Form
    {
        public string idSP;
        public frmRPT_LOINHUAN_SP()
        {
            InitializeComponent();
        }

        private void frmRPT_LOINHUAN_SP_Load(object sender, EventArgs e)
        {
        ...
        private void btnINBC_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    this.LOINHUAN_THEOSPTableAdapter.Fill(this.QL_CUAHANG_THOITRANGDataSet.LOINHUAN_THEOSP, null);
                }
                else
                {
                    this.LOINHUAN_THEOSPTableAdapter.Fill(this.QL_CUAHANG_THOITRANGDataSet.LOINHUAN_THEOSP, idSP);
                }
                if (this.QL_CUAHANG_THOITRANGDataSet.LOINHUAN_THEOSP.Rows.Count > 0)
                {
        ...
        private void btnTAIBC_Click(object sender, EventArgs e)
        {
            if (this.QL_CUAHANG_THOITRANGDataSet.LOINHUAN_THEOSP.Rows.Count > 0)
            {
                try
                {
                    ...
                    saveFileDialog.FileName = "BaoCao_LoiNhuan_TheoSP.pdf";
