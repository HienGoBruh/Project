...
{
    public partial class frmRPT_NHAPHANG : Form
    {
        public frmRPT_NHAPHANG()
        {
            InitializeComponent();
        }
        ...
        private void btnINBC_Click(object sender, EventArgs e)
        {
            ...
            this.BC_NHAPHANGTableAdapter.Fill(this.QL_CUAHANG_THOITRANGDataSet.BC_NHAPHANG, tuNgay, denNgay);
            this.reportViewer1.RefreshReport(); 
        }

        private void btnTAIBC_Click(object sender, EventArgs e)
        {
            if (this.QL_CUAHANG_THOITRANGDataSet.BC_NHAPHANG.Rows.Count > 0)
            {
                try
                {
        ...
        private void cbALLTIME_CheckedChanged(object sender, EventArgs e)
        {
            if (cbALLTIME.Checked)
            {
                ...
                HamXuLy.GetKhoangThoiGianHoaDonNhap(out tuNgay, out denNgay);
        ...
        private void frmRPT_NHAPHANG_Load(object sender, EventArgs e)
        {
