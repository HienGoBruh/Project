...
{
    public partial class frmRPT_DOANHTHU_THEOSP : Form
    {
        public string idSP;
        public frmRPT_DOANHTHU_THEOSP()
        {
            InitializeComponent();
        }

        private void frmRPT_DOANHTHU_THEOSP_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'QL_CUAHANG_THOITRANGDataSet.DOANHTHU_THEOSP' table. You can move, or remove it, as needed.
        ...
        private void btnINBC_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    this.DOANHTHU_THEOSPTableAdapter.Fill(this.QL_CUAHANG_THOITRANGDataSet.DOANHTHU_THEOSP, null);
                }
                else
                {
                    this.DOANHTHU_THEOSPTableAdapter.Fill(this.QL_CUAHANG_THOITRANGDataSet.DOANHTHU_THEOSP, idSP);
                }
                if (this.QL_CUAHANG_THOITRANGDataSet.DOANHTHU_THEOSP.Rows.Count > 0)
                {
        ...
        private void btnTAIBC_Click(object sender, EventArgs e)
        {
            if (this.QL_CUAHANG_THOITRANGDataSet.DOANHTHU_THEOSP.Rows.Count > 0)
            {
                try
                {
                    ...
                    saveFileDialog.FileName = "BaoCao_DoanhThu_TheoSP.pdf";
