        	...
        	<div class="container">
        		<div class="row product_inner_row">
        			<div class="col-lg-9">
        				<div class="row m0 product_task_bar"> 
							<div class="product_task_inner"> 
								<div class="float-left">
									...
									<a style="margin-left: 400px;" href="product.html"><span>Back to main shop</span></a></li>
								</div>
							</div>
        				</div>
                        ...
                        <!-- PHÂN TRANG -->
                        <?php
                            $baseUrl = BASE_URL. "?controller=Product&action=ProductResult";
